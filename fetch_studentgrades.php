...
if (isset($_POST['id'])) {
    ...
    if ($classId) {
        ...
        GROUP BY s.Id
        ORDER BY sub.Subject ASC;  -- Ensuring the subjects are ordered alphabetically
        ");
    ...
    if ($classId === "All") {
        ...
        WHERE 
            row_num = 1
        ORDER BY 
            Fullname ASC, sub.Subject ASC;  -- Ensuring the subjects are ordered alphabetically
        ");
